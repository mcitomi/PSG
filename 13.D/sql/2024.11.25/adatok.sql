...
INSERT INTO varos(id, vnev, vtipid, megyeid, jaras, kisterseg, nepesseg, terulet) VALUES
  ...
  (22,'BalatonfĹązfő',5,20,'Balatonalmádi','Balatonalmádi',4299,9.25),
  ...
  (119,'Héví­z',5,21,'Keszthelyi','Héví­zi',4375,8.31),
  ...
  (181,'Máriapócs',5,17,'Nyí­rbátori','Nyí­rbátori',2042,22.09),
  (182,'MartfĹą',5,12,'Szolnoki','Szolnoki',6435,23.08),
  ...
  (214,'Nyí­radony',4,10,'Nyí­radonyi','Hajdúhadházi',7798,96.59),
  (215,'Nyí­rbátor',4,17,'Nyí­rbátori','Nyí­rbátori',12018,66.73),
  (216,'Nyí­regyháza',2,17,'Nyí­regyházi','Nyí­regyházai',117658,274.54),
  (217,'Nyí­rlugos',5,17,'Nyí­rbátori','Nyí­rbátori',2701,58.38),
  (218,'Nyí­rmada',5,17,'Vásárosnaményi','Baktalórántházai',4762,38.8),
  (219,'Nyí­rtelek',5,17,'Nyí­regyházi','Nyí­regyházai',6783,67.92),
  ...
  (225,'Ĺrbottyán',5,15,'Váci','Veresegyházi',7439,27.38),
  (226,'Ĺriszentpéter',5,19,'Körmendi','Ĺriszentpéteri',1167,33.56),
  (227,'írkény',5,15,'Dabasi','Dabasi',4966,36.44),
  ...
  (249,'Rakamaz',5,17,'Nyí­regyházi','Tiszavasvári',4545,42.64),
  ...
  (319,'íjfehértó',5,17,'Nyí­regyházi','Nagykállói',13005,140.88),
  (320,'íjhartyán',5,15,'Dabasi','Dabasi',2780,22.43),
  (321,'íjkí­gyós',5,3,'Békéscsabai','Békéscsabai',5235,54.92),
  (322,'íjszász',5,12,'Szolnoki','Szolnoki',6360,58.2),
  (323,'íllő',5,15,'Vecsési','Monori',11435,48.1),
  (324,'Vác',4,15,'Váci','Váci',34810,61.6),
  (325,'Vaja',5,17,'Mátészalkai','Mátészalkai',3545,28.61),
  (326,'Vámospércs',5,10,'Nyí­radonyi','Hajdúhadházi',5263,58.19),
