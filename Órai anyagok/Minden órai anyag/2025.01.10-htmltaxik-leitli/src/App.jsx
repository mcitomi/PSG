export default () => {
    return <>
        <div id="content">
            ...
            <hr></hr>
            <img src="/imgs/cab.jpg" className="right" alt="Yellow Cab Company" title="Yellow Cab Company" />
            ...
            <div className="bio">
                <img src="/imgs/hertz.jpg" className="left" />
                ...
                <p className="clr">In 1925, Hertz held the following positions:
                    <ul>
            ...
            <a href="https://en.wikipedia.org/wiki/Yellow_Cab_Company" target="_blank">Wikipédia: Yellow Cab Company</a><br/>
